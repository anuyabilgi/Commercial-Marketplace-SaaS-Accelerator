...
az keyvault create --name $KeyVault --resource-group $ResourceGroupForDeployment --enable-rbac-authorization false  --public-network-access Enabled --enable-purge-protection true --output $azCliOutput
